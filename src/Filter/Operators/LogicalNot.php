...
final readonly class LogicalNot
{
    ...
    public static function create(
        ...
        if (count($classFilters) > 0) {
            yield new \WyriHaximus\Composer\GenerativePluginTooling\Filter\Operators\Class\LogicalNot(...$classFilters);
        }
        ...
        yield new \WyriHaximus\Composer\GenerativePluginTooling\Filter\Operators\Package\LogicalNot(...$packageFilters);
    }
}
